...
export default function VesselSidebar({ vessels, selectedId, onSelect }: Props) {
  ...
  return (
    <div className="flex flex-col h-full bg-white select-none">
      {/* Header */}
      <div className="p-3.5 border-b border-[#182350] bg-[#FAFAF5]">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-1.5 pl-7 rounded-lg text-xs font-sans bg-white border border-[#182350] text-[#182350] placeholder:text-[#94A3B8] outline-none focus:border-[#AFD2FA] transition-all"
          />
            ...
            <button
              ...
              className={`px-2 py-0.5 rounded-md text-[10px] font-mono font-semibold transition-all cursor-pointer whitespace-nowrap ${
                fuelFilter === fuel
                  ...
                  : "bg-white text-[#737985] border border-[#182350] hover:border-[#AFD2FA]"
              }`}
            >
              {fuel}
            </button>
            ...
            <div
              ...
              className={`w-full text-left rounded-xl p-3 transition-all duration-150 cursor-pointer relative border ${
                isSelected
                  ...
                  : "bg-white border-[#182350] hover:border-[#AFD2FA] hover:bg-[#FAFAF5]"
              }`}
            >
      ...
      {/* Footer Info */}
      <div className="p-2.5 border-t border-[#182350] bg-[#FAFAF5] text-[10px] font-mono text-[#737985] flex items-center justify-between">
