                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button
                        ...
                        className="text-xs font-sans font-semibold px-2.5 py-1 rounded-lg border border-[#E6E2D8] text-[#737985] hover:border-[#182350] hover:text-[#182350] bg-white cursor-pointer transition-colors"
                      >
                        Change
                      </button>
                    </div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 mt-4">
                <button
                  onClick={() => setShowAssignModal(false)}
                  className="flex-1 py-2 rounded-lg text-xs font-semibold text-[#737985] border border-[#E6E2D8] hover:bg-[#F7F5EE] cursor-pointer"
                >
                  Cancel
                </button>
                <button
